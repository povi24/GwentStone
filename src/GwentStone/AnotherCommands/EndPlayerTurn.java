...
public class EndPlayerTurn {
    ...
    public EndPlayerTurn(StartingTheGame newgame) {
        ...
        if(newgame.getRoundCounter() == 1) {
            ...
            System.out.println("Round Changed, Hands updated:" );
            System.out.println("Now Hand 1 has this amount of cards: " + newgame.getCardsInHandForPlayerOne().size() );
            System.out.println("Now Hand 2 has this amount of cards: " + newgame.getCardsInHandForPlayerTwo().size() );
