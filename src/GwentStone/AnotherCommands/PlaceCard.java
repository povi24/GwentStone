    ...
    public PlaceCard(ActionsInput action, StartingTheGame newgame, ObjectMapper objectMapper) {
        ...
        if(newgame.getCurrentTurn() == 1) {
            ...
            if(newgame.getCardsInHandForPlayerOne().get(handIdx).getClass().equals(Firestorm.class) ||
                ...
                System.out.println("Error at placing card from player 1 - environment");
                showError = true;
                ...
                System.out.println("Error at placing card from player 1 - mana");
                showError = true;
                ...
                System.out.println("Error at placing card from player 1 - row full");
                showError = true;
               ...
               System.out.println("Card was placed from hand 1, cards remaning: " + newgame.getCardsInHandForPlayerOne().size());
            }
        } else {
            if(newgame.getCardsInHandForPlayerTwo().get(handIdx).getClass().equals(Firestorm.class) ||
                ...
                System.out.println("Error at placing card from player 2 - environment");
                showError = true;
                this.error = "Cannot place environment card on table.";
                node.put("command", command);
                node.put("handIdx", handIdx);
                ...
                System.out.println("Error at placing card from player 2 - mana");
                showError = true;
                this.error = "Not enough mana to place card on table.";
                node.put("command", command);
                node.put("handIdx", handIdx);
                ...
                System.out.println("Error at placing card from player 2 - row full");
                showError = true;
                this.error = "Cannot place card on table since row is full.";
                node.put("command", command);
                node.put("handIdx", handIdx);
                ...
                System.out.println("Card was placed from hand 2, cards remaning: " + newgame.getCardsInHandForPlayerTwo().size());
            }
