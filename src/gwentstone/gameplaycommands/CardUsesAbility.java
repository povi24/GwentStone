...
public class CardUsesAbility {
    ...
    public CardUsesAbility(final ActionsInput action, final StartingTheGame newgame,
        ...
        if (newgame.getCurrentTurn() == 1) {
            ...
            if ((cardAttacked.getX() == 2 || cardAttacked.getX() == 3)
                    ...
                    .get(cardAttacker.getY()).getName().equals("Miraj")
                    || newgame.getTable().getTable().get(cardAttacker.getX())
                    .get(cardAttacker.getY()).getName().equals("The Ripper")
                    || newgame.getTable().getTable().get(cardAttacker.getX())
                    .get(cardAttacker.getY()).equals("The Cursed One"))) {
            ...
            && newgame.getTable().getTable().get(cardAttacker.getX())
                    .get(cardAttacker.getY()).getName().equals("Disciple")) {
                showError = true;
                ...
                newgame.getTable().getTable().get(cardAttacker.getX()).get(cardAttacker.getY())
                        .minionAbility(newgame.getTable().getTable(),
                                cardAttacked.getX(), cardAttacked.getY());
                newgame.getTable().getTable().get(cardAttacker.getX())
                        .get(cardAttacker.getY()).setIfAlreadyAttacked(true);
                if (newgame.getTable().getTable().get(cardAttacked.getX())
                        .get(cardAttacked.getY()).getHealth() <= 0) {
                    newgame.getTable().getTable().get(cardAttacked.getX())
    ...
    private boolean checkIfTankExists(final ArrayList<ArrayList<Minion>> table, final int row) {
        int tankExists = 0;
